...
public class JmsProduce_broker {

    private static final String BROKER_URL = "tcp://127.0.0.1:61616";

    private static final String QUEUE_NAME = "queueandtopic-broker-01";
    ...
    public static void main(String[] args) throws JMSException {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            //6.创建消息
            final TextMessage textMessage = session.createTextMessage("broker msg --" + i);
